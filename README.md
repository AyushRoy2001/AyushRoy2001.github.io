...
- ✌️ **<code style="color: #222">I have published in popular computer vision conferences (ICPR, ICDAR, ACPR, ISBI, MIUA, MIDL, AISTATS, CVPR) and journals (IEEE Transactions, TMLR).</code>**
